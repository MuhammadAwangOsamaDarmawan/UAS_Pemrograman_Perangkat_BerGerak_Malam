package com.perpus.visipustaka.main;
...
import com.perpus.visipustaka.R;
import com.perpus.visipustaka.history.HistoryOrderActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCategories() {
        modelCategories = new ModelCategories(R.drawable.book2, "Koleksi Buku");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.notif, "Notifikasi");
        modelCategoriesList.add(modelCategories);
    ...
    private void setTrending() {
        modelTrending = new ModelTrending(R.drawable.paket_1_vip,"Teknologi Informatika", "2.022 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.paket_3_vip,"Novel", "1.220 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.paket_2_vip,"Teknologi Informatika", "345 disukai");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.paket_4_vip,"Novel", "590 disukai");
        modelTrendingList.add(modelTrending);
