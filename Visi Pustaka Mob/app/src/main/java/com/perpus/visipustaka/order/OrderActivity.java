package com.perpus.visipustaka.order;
...
import com.perpus.visipustaka.utils.FunctionHelper;
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                Toast.makeText(OrderActivity.this, "Ups, pilih Koleksi Buku dulu!",
                        Toast.LENGTH_SHORT).show();
            } else if (totalItems < 10) {
                Toast.makeText(OrderActivity.this, "Ups, minimal Baca Buku yang rajin!",
                        Toast.LENGTH_SHORT).show();
            } else {
                orderViewModel.addDataOrder(strTitle, totalItems, totalPrice);
                Toast.makeText(OrderActivity.this,
                        "Yeay! Buku Anda sedang diproses, cek di menu riwayat ya!",
                        Toast.LENGTH_SHORT).show();
                finish();
            }
        });
